...
type AppTermApiService service

/*
AppTermApiService MEC011 Application Termination notification for self termination
Terminates itself.
...
*/
func (a *AppTermApiService) Mec011AppTerminationPOST(ctx context.Context, body AppTerminationNotification, subscriptionId string) (*http.Response, error) {
	var (
