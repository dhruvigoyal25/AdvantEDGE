...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdvantEdgeBandwidthManagementApi.LocationApi();
  });

  describe('(package)', function() {
    describe('LocationApi', function() {
      describe('mec011AppTerminationPOST', function() {
        it('should call mec011AppTerminationPOST successfully', function(done) {
          // TODO: uncomment, update parameter values for mec011AppTerminationPOST call
          /*

          instance.mec011AppTerminationPOST(body, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
