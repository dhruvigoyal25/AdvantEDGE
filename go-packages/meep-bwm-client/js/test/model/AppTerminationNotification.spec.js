...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AppTerminationNotification', function() {
      beforeEach(function() {
        instance = new AdvantEdgeBandwidthManagementApi.AppTerminationNotification();
      });
      ...
      it('should create an instance of AppTerminationNotification', function() {
        ...
        expect(instance).to.be.a(AdvantEdgeBandwidthManagementApi.AppTerminationNotification);
      });
