...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BwInfoTimeStamp', function() {
      beforeEach(function() {
        instance = new AdvantEdgeBandwidthManagementApi.BwInfoTimeStamp();
      });

      it('should create an instance of BwInfoTimeStamp', function() {
        // TODO: update the code to test BwInfoTimeStamp
        expect(instance).to.be.a(AdvantEdgeBandwidthManagementApi.BwInfoTimeStamp);
      });
