...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AppTerminationNotificationLinks', function() {
      beforeEach(function() {
        instance = new AdvantEdgeBandwidthManagementApi.AppTerminationNotificationLinks();
      });
      ...
      it('should create an instance of AppTerminationNotificationLinks', function() {
        ...
        expect(instance).to.be.a(AdvantEdgeBandwidthManagementApi.AppTerminationNotificationLinks);
      });
