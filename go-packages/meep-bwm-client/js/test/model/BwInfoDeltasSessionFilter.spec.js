...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BwInfoDeltasSessionFilter', function() {
      beforeEach(function() {
        instance = new AdvantEdgeBandwidthManagementApi.BwInfoDeltasSessionFilter();
      });

      it('should create an instance of BwInfoDeltasSessionFilter', function() {
        // TODO: update the code to test BwInfoDeltasSessionFilter
        expect(instance).to.be.a(AdvantEdgeBandwidthManagementApi.BwInfoDeltasSessionFilter);
      });
