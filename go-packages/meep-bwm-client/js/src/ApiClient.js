...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.AdvantEdgeBandwidthManagementApi.ApiClient = factory(root.superagent, root.querystring);
  }
  ...
  var exports = function() {
     ...
     * @type {String}
     * @default https://localhost/sandboxname/bwm/v1
     */
    this.basePath = 'https://localhost/sandboxname/bwm/v1'.replace(/\/+$/, '');
