...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.AdvantEdgeBandwidthManagementApi.BwInfoSessionFilter = factory(root.AdvantEdgeBandwidthManagementApi.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The BwInfoSessionFilter model module.
   * @module model/BwInfoSessionFilter
   * @version 2.2.1
   */

  /**
   * Constructs a new <code>BwInfoSessionFilter</code>.
   * @alias module:model/BwInfoSessionFilter
   * @class
   */
  ...
  /**
   * Constructs a <code>BwInfoSessionFilter</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/BwInfoSessionFilter} obj Optional instance to populate.
   * @return {module:model/BwInfoSessionFilter} The populated <code>BwInfoSessionFilter</code> instance.
   */
